  ...
  return (
    <footer className="bg-[#0f0f0f] text-white mt-16">
      ...
      <div className="max-w-7xl mx-auto px-5 py-14 grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-3 text-sm leading-relaxed">
            ...
            Premium textile wholesale store providing quality sarees,
            dresses & fabrics at best wholesale prices across India.
      ...
      ">
        ...
        © {new Date().getFullYear()} Surat Textile Kankroli. All Rights Reserved.
